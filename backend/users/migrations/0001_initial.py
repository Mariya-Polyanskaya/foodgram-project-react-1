    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Укажите электронная почту', max_length=254, unique=True, verbose_name='Электронная почта')),
                ('username', models.CharField(help_text='Укажите свое имя пользователя', max_length=150, unique=True, verbose_name='Имя пользователя')),
